    ...
    public function run(): void
    {
        $posts = [
            ...
            [
                ...
                'slug' => 'laravel-best-practices-2024',
                'excerpt' => 'Discover the latest best practices and patterns for building robust Laravel applications in 2024.',
                'content' => '<p>Laravel continues to evolve, and staying up-to-date with best practices is crucial for building maintainable applications. Let\'s explore the latest recommendations.</p><h2>Code Organization</h2><p>Proper code organization is essential for maintainability. Use service classes, repositories, and follow SOLID principles.</p>',
